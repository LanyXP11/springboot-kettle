...
<body class="login">
<div class="logo">
    <a href="javascript:void(0)"><span style="font-size: 24px;color: white;">玄壶大数据调度监控平台</span></a>
</div>
<div class="content">
    <form id="loginForm" name="loginForm" class="login-form" action="index/login.shtml" method="POST" novalidate>
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="请输入用户账号"
                       name="uAccount" id="uAccount"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-actions">
            ...
            <button type="button" onclick="submitFrom()" class="btn blue pull-right">登录 <i
